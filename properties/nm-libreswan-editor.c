...
populate_adv_dialog (LibreswanEditor *self)
{
	...
	populate_adv (self, "local_network_entry", NM_LIBRESWAN_KEY_LOCALNETWORK, NULL, NULL);
	populate_adv (self, "remote_network_entry", NM_LIBRESWAN_KEY_REMOTENETWORK, NULL, NULL);
